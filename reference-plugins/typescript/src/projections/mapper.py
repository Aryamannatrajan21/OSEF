...
class GraphMapper:
    ...
    def map_to_graph(self, facts: Sequence[SemanticFact]) -> GraphDelta:
        ...
        # We need a stable mapping. For nodes, typically we should emit a node if it's the subject of a fact
        # But this is a basic 1-to-1 conversion based on facts.
