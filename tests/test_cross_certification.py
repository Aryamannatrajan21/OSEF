...
def test_cross_certification():
    ...
    pipelines = {"typescript": TypeScriptPipeline()}
    ...
    print(
        f"Abstraction Leakage:     {'FAIL' if report.leakage_report.has_leakage else 'PASS (Clean)'}"
    )
    print("=========================================")

    if report.is_certified:
        print(
            "✅ SUCCESS: Engine Self-Validation Passed. SDK is constitutionally isolated and ready for Java."
        )
    else:
