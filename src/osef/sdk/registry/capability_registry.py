...
from osef.sdk.capabilities import (
...
class CapabilityRegistry:
    ...
    def __init__(self) -> None:
        ...
        self._capabilities: Dict[
            Type[CapabilityDescriptor], List[CapabilityDescriptor]
        ] = {ParserCapability: [], GraphEnrichmentCapability: []}
        self._plugin_mapping: Dict[
            CapabilityDescriptor, str
    ...
    def resolve_parser(self, language: str) -> Optional[ParserCapability]:
        ...
        candidates = [
            c
            for c in self._capabilities[ParserCapability]
    ...
    def get_enrichers(self) -> List[GraphEnrichmentCapability]:
        ...
        return [
            c
            for c in self._capabilities.get(GraphEnrichmentCapability, [])
            if isinstance(c, GraphEnrichmentCapability)
        ]
